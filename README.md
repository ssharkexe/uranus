![URANUS × Battle Edition](assets/logo-banner.png)  

![Иконка приложения Uranus](assets/app-icon.png)

**Пакет расширений для Geely Coolray SX11A3**  
Magisk-модуль и приложение настройки для головного устройства на блоках **IHU516** и **IHU535** ([прошивка Community](https://4pda.to/forum/index.php?showtopic=1085149)). Все функции доступны на обоих блоках, кроме связанного с приборкой. Установка одинаковая.

![Magisk module 4.0](https://img.shields.io/badge/модуль-4.0-388bfd?style=flat-square)![APK 4.0](https://img.shields.io/badge/APK-4.0-388bfd?style=flat-square)![IHU516 / IHU535](https://img.shields.io/badge/платформа-IHU516%20%2F%20IHU535-161b22?style=flat-square)![Magisk](https://img.shields.io/badge/Magisk-обязателен-1f883d?style=flat-square)![Android 9](https://img.shields.io/badge/Android-9-3ddc84?style=flat-square)
...
|                                                                          |                                                                   |                                                            |                                                                            |
| ------------------------------------------------------------------------ | ----------------------------------------------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------- |
| ![Шторка и кнопки автомобиля](assets/r40-01.png) Шторка и быстрые кнопки | ![Полоска громкости](assets/r40-02.png) Полоска громкости | ![Центр уведомлений](assets/r40-03.png) Центр уведомлений  | ![Кнопки управления в уведомлении](assets/r40-04.png) Кнопки в уведомлении |
| ![Домашний экран и медиа](assets/r40-05.png) Домашний экран              | ![Панель Куда едем](assets/r40-06.png) Куда едем?                 | ![Настройки лаунчера](assets/r40-07.png) Лаунчер           | ![Оформление день и ночь](assets/r40-08.png) Оформление                    |
| ![Слоты статусбара](assets/r40-09.png) Статусбар                         | ![Кнопки левой панели](assets/r40-10.png) Левая панель            | ![Климат в навбаре](assets/r40-11.png) Климат в навбаре    | ![Слоты навбара](assets/r40-12.png) Навбар                                 |
| ![Настройки автомобиля и климата](assets/r40-13.png) Автомобиль и климат | ![Свайпы двумя пальцами](assets/r40-14.png) Свайпы двумя пальцами | ![Кнопки руля](assets/r40-15.png) Кнопки руля              | ![Действия кнопок руля](assets/r40-16.png) Действия на руле                |
| ![Настройки кнопок](assets/r40-17.png) Настройки кнопок                  | ![Переназначение руля](assets/r40-18.png) Переназначение          | ![Список действий руля](assets/r40-19.png) Список действий | ![Сплит карта и музыка](assets/r40-20.png) Сплит: карта и музыка           |
