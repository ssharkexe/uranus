...
<p align="center">
  <img src="https://img.shields.io/badge/модуль-4.2-388bfd?style=flat-square" alt="Magisk module 4.2">
  <img src="https://img.shields.io/badge/APK-4.2-388bfd?style=flat-square" alt="APK 4.2">
...
| 📋 **Действия переназначения**   | Для назначения доступны системные действия (домой, назад и тд), запуск приложений, голосовое управление, управление функциями и опциями авто (вкл/выкл электронной заслонки выхлопа и др.), запуск сплит-скрина, **скрытие/показ навбара** и тд |
| ✌️ **Свайп 2 пальцами**          | Влево или вправо — то же меню действий, что у кнопок руля (в том числе скрытие/показ навбара)                                                                                                                          |
| 🖐️ **Свайп 3 пальцами**          | В левой половине экрана: громкость или температура (шаг 0,5 °C), пока пальцы на экране; шаг — 20 пикселей вверх/вниз                                                                                                   |
...
| 🙈 **Навбар в сплите**                      | Опция автоскрытия навбара при запуске сплит-скрина; с руля или свайпа 2 пальцами навбар можно скрыть/показать в приложении (на лаунчере скрытие недоступно)                                                                                                                                                                 |
...
| 🔊 **Полоска громкости**                    | Редизайн: вертикальная капсула, громкость можно менять пальцем; исправлены цвет и динамическая геометрия заливки                                                                                                                                                                                                            |
...
| ⏯️ **Start-Stop в Eco**           | При переходе в Eco отключает Start-Stop, только если остаётесь в Eco ~2 с и система уже включена (проскок Eco не трогает)                                                                   |
| 🎵 **Автовоспроизведение**        | Опция продолжить последний музыкальный плеер после старта ГУ                                                                                                                                |
...
| 💨 **Уведомления обдува климата** | Короткая toast-панель с текущим режимом обдува при нажатии кнопки MODE; режим можно менять перетаскиванием ползунка на панели                                                               |
...
| 🎬 **Анимация режима вождения**   | Селект **Полноэкранная / Всплывающая / Нет**. Всплывающая — toast-панель Comfort → Adaptive → Sport → Eco при переключении селектором (отдельный модуль больше не нужен)                    |
...
| 🛰️ **Сброс кэша GPS**  | Обновлённый сброс кэша — быстрее восстанавливает локацию в навигаторах после зоны глушилок |
...
- Анимация режима вождения: **Полноэкранная / Всплывающая / Нет**; всплывающая — toast Comfort → Adaptive → Sport → Eco
- Климат: toast при MODE, режим меняется перетаскиванием ползунка
- Свайп 3 пальцами слева: громкость или температура (шаг 20 px)
- Скрытие навбара с руля / 2 пальцев; автоскрытие в сплите
- Фикс полоски громкости, цвета текста статусбара, Start-Stop в Eco (~2 с)
- Лаунчер: без раздутия стоковой БД; GPS-кэш; автовоспроизведение плеера после старта
...
| **Лаунчер**             | Виджеты, быстрый запуск, навбар; возврат на выбранный виджет через 15 / 30 / 45 секунд; исправлено переполнение стоковой БД (быстрее загрузка) |
