...
| 🚗 **Uranus.Авто**            | Виджет настроек автомобиля: 10 настраиваемых слотов — память сидений, окна, режим мойки, **электронная заслонка выхлопа**, смена темы и др.                                                                                                      |
...
| Функция                           | Описание                                                                                                                      |
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 🔇 **Приглушение медиа (R)**      | Настраиваемая глубина приглушения музыки при задней передаче и работе парктроников/камеры (от «Минимальная» до «Максимальное»); по умолчанию — минимальное приглушение |
...
| 🎬 **Анимация режима вождения**   | Отключение полноэкранной анимации при смене Adaptive/Eco/Comfort/Sport (опциональный модуль `uranus-xcsettings-magisk.zip` + переключатель во вкладке «Автомобиль») |
